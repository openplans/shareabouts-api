...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sa_api_v2_dataindex', (
        ...
        db.send_create_signal('sa_api_v2', ['DataIndex'])

        # Adding model 'IndexedValue'
        db.create_table('sa_api_v2_indexedvalue', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('sa_api_v2', ['IndexedValue'])


    def backwards(self, orm):
        # Deleting model 'DataIndex'
        db.delete_table('sa_api_v2_dataindex')

        # Deleting model 'IndexedValue'
        db.delete_table('sa_api_v2_indexedvalue')
    ...
    models = {
        ...
        'sa_api_v2.indexedvalue': {
            ...
            'thing': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sa_api_v2.SubmittedThing']"}),
