...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('sa_api_v2_grouppermission', 'can_retrieve',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'GroupPermission.priority'
        db.add_column('sa_api_v2_grouppermission', 'priority',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'OriginPermission.can_retrieve'
        db.add_column('sa_api_v2_originpermission', 'can_retrieve',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'OriginPermission.priority'
        db.add_column('sa_api_v2_originpermission', 'priority',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'KeyPermission.can_retrieve'
        db.add_column('sa_api_v2_keypermission', 'can_retrieve',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'KeyPermission.priority'
        db.add_column('sa_api_v2_keypermission', 'priority',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('sa_api_v2_grouppermission', 'can_retrieve')

        # Deleting field 'GroupPermission.priority'
        db.delete_column('sa_api_v2_grouppermission', 'priority')

        # Deleting field 'OriginPermission.can_retrieve'
        db.delete_column('sa_api_v2_originpermission', 'can_retrieve')

        # Deleting field 'OriginPermission.priority'
        db.delete_column('sa_api_v2_originpermission', 'priority')

        # Deleting field 'KeyPermission.can_retrieve'
        db.delete_column('sa_api_v2_keypermission', 'can_retrieve')

        # Deleting field 'KeyPermission.priority'
        db.delete_column('sa_api_v2_keypermission', 'priority')
