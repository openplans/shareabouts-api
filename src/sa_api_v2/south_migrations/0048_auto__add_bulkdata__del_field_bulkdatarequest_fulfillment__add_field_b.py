...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sa_api_bulkdata', (
            ...
            ('request', self.gf('django.db.models.fields.related.OneToOneField')(related_name='fulfillment', unique=True, null=True, to=orm['sa_api_v2.BulkDataRequest'])),
            ('content', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('sa_api_v2', ['BulkData'])

        # Deleting field 'BulkDataRequest.fulfillment'
        db.delete_column('sa_api_bulkdatarequest', 'fulfillment')

        # Adding field 'BulkDataRequest.include_private'
        db.add_column('sa_api_bulkdatarequest', 'include_private',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BulkDataRequest.include_invisible'
        db.add_column('sa_api_bulkdatarequest', 'include_invisible',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BulkDataRequest.include_submissions'
        db.add_column('sa_api_bulkdatarequest', 'include_submissions',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('sa_api_bulkdatarequest', 'include_private')

        # Deleting field 'BulkDataRequest.include_invisible'
        db.delete_column('sa_api_bulkdatarequest', 'include_invisible')

        # Deleting field 'BulkDataRequest.include_submissions'
        db.delete_column('sa_api_bulkdatarequest', 'include_submissions')
    ...
    models = {
        'apikey.apikey': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'YzE5ZTIzM2EzODg1NzRmYTQzMDgzYWMx'", 'unique': 'True', 'max_length': '32'}),
