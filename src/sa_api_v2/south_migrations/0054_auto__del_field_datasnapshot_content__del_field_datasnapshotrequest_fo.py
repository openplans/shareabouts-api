...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DataSnapshot.content'
        db.delete_column('sa_api_datasnapshot', 'content')

        # Deleting field 'DataSnapshotRequest.format'
        db.delete_column('sa_api_datasnapshotrequest', 'format')


    def backwards(self, orm):
        # Adding field 'DataSnapshot.content'
        db.add_column('sa_api_datasnapshot', 'content',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'DataSnapshotRequest.format'
        db.add_column('sa_api_datasnapshotrequest', 'format',
                      self.gf('django.db.models.fields.CharField')(default='json', max_length=16),
                      keep_default=False)
    ...
    models = {
        'apikey.apikey': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'MTZhNjIzYjU5NmRkN2Y5YzU3ZjNkNWQz'", 'unique': 'True', 'max_length': '32'}),
