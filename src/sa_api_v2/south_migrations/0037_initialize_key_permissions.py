...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for key in orm['apikey.ApiKey'].objects.all():
            # For backwards compatibility, existing api keys can do everything.
            key.permissions.add(orm.KeyPermission(can_update=True, can_create=True, can_destroy=True))
    ...
    models = {
        ...
        'sa_api_v2.keypermission': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['apikey.ApiKey']", 'related_name': "'permissions'"}),
        ...
        'sa_api_v2.originpermission': {
            ...
            'can_update': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'origin': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cors.Origin']", 'related_name': "'permissions'"}),
            'submission_set': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'})
        },
        'sa_api_v2.place': {
        ...
        'sa_api_v2.grouppermission': {
            ...
            'can_update': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sa_api_v2.Group']", 'related_name': "'permissions'"}),
            'submission_set': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'})
        },
