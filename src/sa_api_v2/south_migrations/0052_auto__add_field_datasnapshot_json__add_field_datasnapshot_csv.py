...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataSnapshot.json'
        db.add_column('sa_api_datasnapshot', 'json',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'DataSnapshot.csv'
        db.add_column('sa_api_datasnapshot', 'csv',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataSnapshot.json'
        db.delete_column('sa_api_datasnapshot', 'json')

        # Deleting field 'DataSnapshot.csv'
        db.delete_column('sa_api_datasnapshot', 'csv')
    ...
    models = {
        'apikey.apikey': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'ZjVlMWFjODYwNGE1YzRhMWM4YTE0NTA5'", 'unique': 'True', 'max_length': '32'}),
