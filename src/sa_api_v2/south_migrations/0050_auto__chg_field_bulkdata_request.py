...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BulkData.request'
        db.alter_column('sa_api_bulkdata', 'request_id', self.gf('django.db.models.fields.related.OneToOneField')(default=0, unique=True, to=orm['sa_api_v2.BulkDataRequest']))

    def backwards(self, orm):

        # Changing field 'BulkData.request'
        db.alter_column('sa_api_bulkdata', 'request_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['sa_api_v2.BulkDataRequest']))
    ...
    models = {
        'apikey.apikey': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'Y2UwN2U4MGU4ZmRjYzQzZDhjMWZmNjA5'", 'unique': 'True', 'max_length': '32'}),
        ...
        'sa_api_v2.bulkdata': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'request': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'fulfillment'", 'unique': 'True', 'to': "orm['sa_api_v2.BulkDataRequest']"})
        },
