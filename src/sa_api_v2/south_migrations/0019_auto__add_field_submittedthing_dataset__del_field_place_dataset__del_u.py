...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('sa_api_submittedthing', 'dataset',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='submitted_thing_set', null=True, to=orm['sa_api_v2.DataSet']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('sa_api_place', 'dataset',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='place_set', null=True, to=orm['sa_api_v2.DataSet'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'sa_api_v2.submittedthing': {
            ...
            'dataset': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'submitted_thing_set'", 'null': 'True', 'to': "orm['sa_api_v2.DataSet']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
