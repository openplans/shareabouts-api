...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sa_api_bulkdatarequest', (
            ...
            ('fulfillment', self.gf('django.db.models.fields.TextField')()),
        ))
    ...
    models = {
        'apikey.apikey': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'Njg5Y2FkMzdlY2VkY2JiMjYxYTk0ZTM4'", 'unique': 'True', 'max_length': '32'}),
        ...
        'sa_api_v2.bulkdatarequest': {
            ...
            'fulfillment': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
