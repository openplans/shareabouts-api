...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('sa_api_submission', 'place',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='submissions', null=True, to=orm['sa_api_v2.Place']),
                      keep_default=False)

        # Adding field 'Submission.set_name'
        db.add_column('sa_api_submission', 'set_name',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('sa_api_submission', 'place_id')

        # Deleting field 'Submission.set_name'
        db.delete_column('sa_api_submission', 'set_name')
    ...
    models = {
        'apikey.apikey': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'OWI1MDEwMjI3OTgxNjY2NzRkOWRmOTBl'", 'unique': 'True', 'max_length': '32'}),
        ...
        'sa_api_v2.submission': {
            ...
            'place': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'submissions'", 'null': 'True', 'to': "orm['sa_api_v2.Place']"}),
            'set_name': ('django.db.models.fields.TextField', [], {'default': "''", 'db_index': 'True'}),
            'submittedthing_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['sa_api_v2.SubmittedThing']", 'unique': 'True', 'primary_key': 'True'})
        },
