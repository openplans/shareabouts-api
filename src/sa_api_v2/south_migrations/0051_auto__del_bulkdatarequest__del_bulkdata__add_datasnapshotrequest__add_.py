...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'BulkDataRequest'
        db.delete_table('sa_api_bulkdatarequest')

        # Deleting model 'BulkData'
        db.delete_table('sa_api_bulkdata')

        # Adding model 'DataSnapshotRequest'
        db.create_table('sa_api_datasnapshotrequest', (
            ...
            ('include_private', self.gf('django.db.models.fields.BooleanField')()),
            ('include_invisible', self.gf('django.db.models.fields.BooleanField')()),
            ('include_submissions', self.gf('django.db.models.fields.BooleanField')()),
            ('requester', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sa_api_v2.User'], null=True)),
            ...
            ('fulfilled_at', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('guid', self.gf('django.db.models.fields.TextField')(default='', unique=True, blank=True)),
        ))
        db.send_create_signal('sa_api_v2', ['DataSnapshotRequest'])

        # Adding model 'DataSnapshot'
        db.create_table('sa_api_datasnapshot', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('request', self.gf('django.db.models.fields.related.OneToOneField')(related_name='fulfillment', unique=True, to=orm['sa_api_v2.DataSnapshotRequest'])),
            ('content', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('sa_api_v2', ['DataSnapshot'])


    def backwards(self, orm):
        # Adding model 'BulkDataRequest'
        db.create_table('sa_api_bulkdatarequest', (
            ('dataset', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sa_api_v2.DataSet'])),
            ('status', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
            ('format', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('requester', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sa_api_v2.User'], null=True)),
        ...
        db.send_create_signal('sa_api_v2', ['BulkDataRequest'])

        # Adding model 'BulkData'
        db.create_table('sa_api_bulkdata', (
            ('content', self.gf('django.db.models.fields.TextField')()),
            ('request', self.gf('django.db.models.fields.related.OneToOneField')(related_name='fulfillment', unique=True, to=orm['sa_api_v2.BulkDataRequest'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('sa_api_v2', ['BulkData'])

        # Deleting model 'DataSnapshotRequest'
        db.delete_table('sa_api_datasnapshotrequest')

        # Deleting model 'DataSnapshot'
        db.delete_table('sa_api_datasnapshot')
    ...
    models = {
        'apikey.apikey': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'MThiMjE3ZTUwYzI4ZjliZGQyN2ViZTli'", 'unique': 'True', 'max_length': '32'}),
        ...
        'sa_api_v2.datasnapshot': {
            'Meta': {'object_name': 'DataSnapshot', 'db_table': "'sa_api_datasnapshot'"},
            'content': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'request': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'fulfillment'", 'unique': 'True', 'to': "orm['sa_api_v2.DataSnapshotRequest']"})
        },
        'sa_api_v2.datasnapshotrequest': {
            'Meta': {'object_name': 'DataSnapshotRequest', 'db_table': "'sa_api_datasnapshotrequest'"},
