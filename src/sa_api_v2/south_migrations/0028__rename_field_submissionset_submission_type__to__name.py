...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('sa_api_submissionset', ['submission_type', 'place_id'])

        # Renaming field 'SubmissionSet.submission_type' to 'SubmissionSet.name'
        db.rename_column('sa_api_submissionset', 'submission_type', 'name')
    ...
    def backwards(self, orm):
        ...
        db.rename_column('sa_api_submissionset', 'name', 'submission_type')

        # Adding unique constraint on 'SubmissionSet', fields ['submission_type', 'place']
        db.create_unique('sa_api_submissionset', ['submission_type', 'place_id'])
