...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        SubmittedThing = orm['sa_api_v2.SubmittedThing']
        ...
        db.alter_column('sa_api_submittedthing', 'dataset_id', self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['sa_api_v2.DataSet']))

    def backwards(self, orm):

        # Changing field 'SubmittedThing.dataset'
        db.alter_column('sa_api_submittedthing', 'dataset_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['sa_api_v2.DataSet']))
    ...
    models = {
        ...
        'sa_api_v2.dataset': {
            'Meta': {'unique_together': "(('owner', 'short_name'),)", 'object_name': 'DataSet', 'db_table': "'sa_api_dataset'"},
