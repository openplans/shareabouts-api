...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        all_sets = list(SubmissionSet.objects.all().prefetch_related('children'))
        with transaction.atomic():
            for sset in all_sets:
                sset.children.all().update(set_name=sset.name, place=sset.place_id)
    ...
    models = {
        'apikey.apikey': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'OGM4NWY2OTQ2Y2EwNTMyYjdiMDhmYjEy'", 'unique': 'True', 'max_length': '32'}),
