...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DataSet.short_name'
        db.delete_column('sa_api_dataset', 'short_name')

        # Adding unique constraint on 'DataSet', fields ['owner', 'slug']
        db.create_unique('sa_api_dataset', ['owner_id', 'slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'DataSet', fields ['owner', 'slug']
        db.delete_unique('sa_api_dataset', ['owner_id', 'slug'])
