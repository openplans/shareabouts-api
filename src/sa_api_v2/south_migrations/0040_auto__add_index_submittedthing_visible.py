...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'SubmittedThing', fields ['visible']
        db.create_index('sa_api_submittedthing', ['visible'])


    def backwards(self, orm):
        # Removing index on 'SubmittedThing', fields ['visible']
        db.delete_index('sa_api_submittedthing', ['visible'])
