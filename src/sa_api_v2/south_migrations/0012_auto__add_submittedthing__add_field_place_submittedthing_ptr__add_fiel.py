...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('sa_api_v2', ['SubmittedThing'])

        # Adding field 'Place.submittedthing_ptr'
        db.add_column('sa_api_place', 'submittedthing_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sa_api_v2.SubmittedThing'], unique=True, null=True),
                      keep_default=False)
    ...
    models = {
        ...
        'sa_api_v2.place': {
            ...
            'submittedthing_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['sa_api_v2.SubmittedThing']", 'unique': 'True', 'null': 'True'}),
