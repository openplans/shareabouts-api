...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for snapshot in orm.DataSnapshot.objects.all():
            format = snapshot.request.format
            setattr(snapshot, format, snapshot.content)
            snapshot.save()
    ...
    def backwards(self, orm):
        ...
        for snapshot in orm.DataSnapshot.objects.all():
            format = snapshot.request.format
            snapshot.content = getattr(snapshot, format)
            snapshot.save()
    ...
    models = {
        'apikey.apikey': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'MDE1MmY2ZWY3NzZiYjI1MWE0MWY1ZDhm'", 'unique': 'True', 'max_length': '32'}),
