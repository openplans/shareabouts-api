...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_table(u'cors_originpermission', u'cors_origin')
        db.rename_column('cors_originpermission_datasets', 'originpermission_id', 'origin_id')
        db.rename_table(u'cors_originpermission_datasets', u'cors_origin_datasets')


    def backwards(self, orm):
        # Deleting model 'Origin'
        db.rename_table(u'cors_origin', u'cors_originpermission')
        db.rename_column('cors_origin_datasets', 'origin_id', 'originpermission_id')
        db.rename_table(u'cors_origin_datasets', u'cors_originpermission_datasets')
