...
# NOTE: This migration deletes the user field from the logical definition of
#       ApiKey, but keeps the field in the table for backwards compatibility.

class Migration(SchemaMigration):

    def forwards(self, orm):
        # Deleting field 'ApiKey.user'
        # db.delete_column('apikey_apikey', 'user_id')
        pass


    def backwards(self, orm):
        # Adding field 'ApiKey.user'
        # db.add_column('apikey_apikey', 'user',
        #               self.gf('django.db.models.fields.related.ForeignKey')(related_name='api_keys', null=True, to=orm['auth.User']),
        #               keep_default=False)
        pass
