...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('apikey_apikey_datasets', (
        ...
        db.create_unique('apikey_apikey_datasets', ['apikey_id', 'dataset_id'])


    def backwards(self, orm):
        # Deleting model 'ApiKey'
        db.delete_table('apikey_apikey')

        # Removing M2M table for field datasets on 'ApiKey'
        db.delete_table('apikey_apikey_datasets')


    models = {
        'apikey.apikey': {
            'Meta': {'object_name': 'ApiKey'},
            'datasets': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['sa_api_v2.DataSet']", 'symmetrical': 'False', 'blank': 'True'}),
