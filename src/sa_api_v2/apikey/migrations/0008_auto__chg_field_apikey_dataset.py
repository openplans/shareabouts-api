...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field datasets on 'ApiKey'
        db.delete_table(db.shorten_name(u'apikey_apikey_datasets'))


        # Changing field 'ApiKey.dataset'
        db.alter_column('apikey_apikey', 'dataset_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sa_api_v2.DataSet']))

    def backwards(self, orm):
        # Adding M2M table for field datasets on 'ApiKey'
        m2m_table_name = db.shorten_name(u'apikey_apikey_datasets')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('apikey', models.ForeignKey(orm[u'apikey.apikey'], null=False)),
            ('dataset', models.ForeignKey(orm[u'sa_api_v2.dataset'], null=False))
        ))
        db.create_unique(m2m_table_name, ['apikey_id', 'dataset_id'])


        # Changing field 'ApiKey.dataset'
        db.alter_column('apikey_apikey', 'dataset_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['sa_api_v2.DataSet']))
