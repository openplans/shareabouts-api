...
class Migration(DataMigration):
    ...
    models = {
        ...
        u'sa_api_v2.keypermission': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['apikey.ApiKey']", 'related_name': "'permissions'"}),
        ...
        u'sa_api_v2.originpermission': {
            ...
            'can_update': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'origin': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cors.Origin']", 'related_name': "'permissions'"}),
            'submission_set': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'})
        },
        u'sa_api_v2.place': {
