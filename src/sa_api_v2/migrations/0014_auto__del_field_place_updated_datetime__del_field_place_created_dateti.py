...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('sa_api_place', 'submittedthing_ptr_id', self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['sa_api_v2.SubmittedThing'], unique=True, primary_key=True))
        ...
        db.alter_column('sa_api_submission', 'submittedthing_ptr_id', self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['sa_api_v2.SubmittedThing'], unique=True, primary_key=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Place.submittedthing_ptr'
        db.alter_column('sa_api_place', 'submittedthing_ptr_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sa_api_v2.SubmittedThing'], unique=True, null=True))
        ...
        # Changing field 'Submission.submittedthing_ptr'
        db.alter_column('sa_api_submission', 'submittedthing_ptr_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sa_api_v2.SubmittedThing'], unique=True, null=True))
