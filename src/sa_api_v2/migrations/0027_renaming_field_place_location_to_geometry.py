...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'Place.location' to 'Place.geometry'
        db.rename_column('sa_api_place', 'location', 'geometry')

        # Altering field 'Place.geometry'
        db.alter_column('sa_api_place', 'geometry',
                      self.gf('django.contrib.gis.db.models.fields.GeometryField')())

    def backwards(self, orm):
        # Renaming field 'Place.geometry'
        db.rename_column('sa_api_place', 'geometry', 'location')

        # Altering field 'Place.location'
        db.alter_column('sa_api_place', 'location',
