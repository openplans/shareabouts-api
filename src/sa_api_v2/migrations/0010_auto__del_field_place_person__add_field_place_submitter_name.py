...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'Place.person' to 'Place.submitter_name'
        db.rename_column('sa_api_place', 'person', 'submitter_name')


    def backwards(self, orm):
        # Renaming field 'Place.submitter_name' to 'Place.person'
        db.rename_column('sa_api_place', 'submitter_name', 'person')
